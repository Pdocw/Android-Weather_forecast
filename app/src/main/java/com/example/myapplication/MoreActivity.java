...
//                获取目前的默认壁纸
    ...
    private void shareSoftwareMsg() {
        ...
        ClipData mClipData = ClipData.newPlainText("Label", "https://wwa.lanzous.com/b00u3p9be");
        // 将ClipData内容放到系统剪贴板里。显示更多文件
        cm.setPrimaryClip(mClipData);
        Toast.makeText(this, "下载链接已复制到剪切板", Toast.LENGTH_SHORT).show();
